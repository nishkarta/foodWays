            ...
            <Container className='py-5 text-center text-lg-start'>
                <Row className='d-flex align-items-center px-5 mx-4'>
                    <Col className='col-12 col-lg-7 text-brown'>
                        ...
                        <Row>
                            <Col className='col-12 col-lg-4 me-lg-1 mb-3'>
                                <img src={rectangle2} alt="" />
                            </Col>
                            <Col className='mb-1 ff-avenir text-dark f-14 '><p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
                            </Col>
                        </Row>
                    </Col>
